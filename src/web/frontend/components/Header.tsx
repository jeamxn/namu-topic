      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-baseline gap-3 min-w-0">
            <h1 className="font-display text-base sm:text-lg font-medium tracking-tight text-zinc-100 truncate">
              나무위키 실시간 검색어
            </h1>
            <span className="hidden md:inline text-[11px] uppercase tracking-[0.18em] text-zinc-600">
              Trending Index
            </span>
          </div>
          ...
          {lastUpdated && (
            <div className="flex items-center gap-2 shrink-0">
              ...
              <span className="mono tabular text-xs sm:text-sm text-zinc-300">
            ...
            <div className="marquee__track">
              {tickerLoop.map((item, idx) => (
                <span
                  ...
                  <span className="text-zinc-200">{item.keyword}</span>
                </span>
              ))}
            </div>
          </div>
